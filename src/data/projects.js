const projects = [
    {
        ...
        description:
            "A powerful PDF stamping tool designed for welding map inspections. It allows users to add watermarks, timestamps, and annotations to ensure secure and professional document handling.",
    ...
    },
    {
        ...
        description:
            "An advanced app that enables accurate measurement, annotation, and visualization for various inspection workflows, tailored for professionals.",
    ...
    },
    {
        ...
        description:
            "A tool for marking and annotating plans, particularly useful in welding and construction workflows, ensuring efficient documentation.",
    ...
    },
    {
        ...
        description:
            "A tool for designing and analyzing Data Flow Diagrams (DFDs) with robust in-house services.",
    ...
    },
    {
        ...
        title: "Weld Map App",
        description:
            "A comprehensive application tailored for managing weld mapping documentation, providing tools for annotation, process visualization, and reporting.",
    ...
    },
    {
        ...
        title: "Build Studio",
        description:
            "An application to assist in setting up studio environments for seamless in-house operations.",
        video: "",
        screenshots: [
    ...
    },
    {
        ...
        description:
            "A platform designed to help football coaches create, manage, and execute strategies effortlessly.",
        video: "",
        screenshots: [
    ...
    },
    {
        ...
        title: "Logoflow App",
        description:
            "A tool for designing and managing logos efficiently, with multiple customization options for branding professionals.",
        video: "",
        screenshots: [
    ...
    },
    {
        ...
        description:
            "An interactive application for designing T-shirts with real-time preview and customization options.",
        video: "",
        screenshots: [
    ...
    },
    {
        ...
        description:
            "An innovative tool that generates and customizes images based on user inputs, streamlining workflows for graphic and visual design.",
        video: "",
        screenshots: [
